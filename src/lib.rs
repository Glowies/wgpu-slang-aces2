...
pub async fn run() -> anyhow::Result<()> {
    ...
    let input_data = vec![3u32, 1u32, 4u32, 1u32, 5u32, 9u32, 2u32];
    let mut output_data = vec![0u32];
    ...
    // CREATE BIND GROUP FOR THE COMPUTER SHADER
    ...
    // ENQUEUE THE COMPUTE SHADER AND BUFFER COPY
    ...
    // GET INFO BACK FROM GPU
    {
        ...
        output_data = bytemuck::cast_slice(&buffer_view).to_vec();
    }
